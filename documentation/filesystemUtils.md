...
| ------ | ------ | ------ | ------ |
| `path?` | `string` | Path where the temporary file should be created. | [src/filesystemUtils.mts:18](https://github.com/mangs/bun-utils/blob/36ca463ec2c14b9ec09d9495eb93ec11d9685583/src/filesystemUtils.mts#L18) |
| `writerOptions?` | `object` | Options object defined by the first parameter accepted by `BunFile.writer()`. | [src/filesystemUtils.mts:22](https://github.com/mangs/bun-utils/blob/36ca463ec2c14b9ec09d9495eb93ec11d9685583/src/filesystemUtils.mts#L22) |
...
[src/filesystemUtils.mts:34](https://github.com/mangs/bun-utils/blob/36ca463ec2c14b9ec09d9495eb93ec11d9685583/src/filesystemUtils.mts#L34)
...
[src/filesystemUtils.mts:76](https://github.com/mangs/bun-utils/blob/36ca463ec2c14b9ec09d9495eb93ec11d9685583/src/filesystemUtils.mts#L76)
...
[src/filesystemUtils.mts:52](https://github.com/mangs/bun-utils/blob/36ca463ec2c14b9ec09d9495eb93ec11d9685583/src/filesystemUtils.mts#L52)
...
[src/filesystemUtils.mts:97](https://github.com/mangs/bun-utils/blob/36ca463ec2c14b9ec09d9495eb93ec11d9685583/src/filesystemUtils.mts#L97)
...
| ------ | ------ | ------ | ------ |
| `[asyncDispose]` | `Promise`\<`void`\> | Asynchronous automatic disposal function. | [src/filesystemUtils.mts:156](https://github.com/mangs/bun-utils/blob/36ca463ec2c14b9ec09d9495eb93ec11d9685583/src/filesystemUtils.mts#L156) |
| `append` | `Promise`\<`void`\> | Append string contents to the target temporary file. | [src/filesystemUtils.mts:146](https://github.com/mangs/bun-utils/blob/36ca463ec2c14b9ec09d9495eb93ec11d9685583/src/filesystemUtils.mts#L146) |
...
[src/filesystemUtils.mts:136](https://github.com/mangs/bun-utils/blob/36ca463ec2c14b9ec09d9495eb93ec11d9685583/src/filesystemUtils.mts#L136)
